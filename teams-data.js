...
const playersData = [
    ...
    { playerName: 'Andrea Sciamanna', teams: ['ILEFER','Le bimbe di Barbieri', 'Sfilettati'], points: 0, eliminato: false},
    { playerName: 'Anna Pisano', teams: [], points: 2, eliminato: false},
    { playerName: 'Antonio Mazzola', teams: ['ILEFER', 'Cannavacciuoli', 'Le bimbe di Barbieri'], points: 5, eliminato: false},
    { playerName: 'Beatrice Belli', teams: ['Cannavacciuoli'], points: 0, eliminato: false},
    { playerName: 'Deborah Meloni', teams: ['Le bimbe di Barbieri', 'ILEFER'], points: 2, eliminato: false},
    ...
    { playerName: 'Marcus Agerstroem', teams: ['ILEFER', 'Le bimbe di Barbieri', 'Sfilettati'], points: 0, eliminato: false},
    { playerName: 'Michela Morelli', teams: ['Cannavacciuoli'], points: 0, eliminato: false},
    { playerName: 'Niccolò Califano', teams: ['ILEFER', 'Le bimbe di Barbieri', 'Sfilettati'], points: 0, eliminato: false},
    { playerName: 'Nicolò Molinari', teams: ['Cannavacciuoli', 'Le bimbe di Barbieri'], points: 2, eliminato: false},
