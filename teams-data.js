...
const playersData = [
    { playerName: 'Alberto Pierobon', teams: ['Famechimica', 'GiovyRana Team', 'Brunobrio'], detailedPoints: [{ day: 1, activity: 'Esterna', value: 2 }, { day: 1, activity: 'Invention', value: 2 }, { day: 1, activity: 'Esterna', value: 2 }], eliminato: false},
    { playerName: 'Alice Scaffardi', teams: ['Sfilettati', 'Cracchini','Brunobrio'], detailedPoints: [{ day: 1, activity: 'MisteryBox', value: 3 }, { day: 1, activity: 'Esterna', value: 2 }], eliminato: false},
    { playerName: 'Andrea Sciamanna', teams: ['Gli Stellati','Bimbe di Barbieri', 'Sfilettati','PizzaHot'], detailedPoints: [{ day: 1, activity: 'Esterna', value: 2 }], eliminato: false},
    { playerName: 'Anna Pisano', teams: ['Famechimica','Brunobrio'], detailedPoints: [{ day: 1, activity: 'Esterna', value: 2 },{ day: 1, activity: 'Eliminazione', value: 10 }], eliminato: true},
    { playerName: 'Antonio Mazzola', teams: ['Gli Stellati', 'Cannavacciuoli', 'Bimbe di Barbieri', 'GiovyRana Team', 'Craccosanti','Brunobrio'], detailedPoints: [{ day: 1, activity: 'MisteryBox', value: 3 }, { day: 1, activity: 'Esterna', value: 2 }, { day: 1, activity: 'Esterna', value: 2 }], eliminato: false},
    { playerName: 'Beatrice Belli', teams: ['Cannavacciuoli', 'Cracchini','Brunobrio'], detailedPoints: [{ day: 1, activity: 'Eliminazione', value: 8 }], eliminato: true},
    { playerName: 'Deborah Meloni', teams: ['Bimbe di Barbieri', 'Gli Stellati', 'GiovyRana Team', 'Craccosanti'], detailedPoints: [{ day: 1, activity: 'Esterna', value: 2 }, { day: 1, activity: 'MisteryBox', value: 3 }, { day: 1, activity: 'Esterna', value: 2 }], eliminato: false},
    ...
    { playerName: 'Filippo Baldo', teams: ['Gli Stellati', 'Famechimica', 'Cracchini'], detailedPoints: [{ day: 1, activity: 'Esterna', value: 2 }, { day: 1, activity: 'Esterna', value: 2 }], eliminato: false},
    ...
    { playerName: 'Michela Morelli', teams: ['Cannavacciuoli', 'Craccosanti'], detailedPoints: [{ day: 1, activity: 'Invention', value: 2 }, { day: 1, activity: 'MisteryBox', value: 3 }], eliminato: false},
    ...
    { playerName: 'Sara Bellinzona', teams: ['Famechimica', 'Cracchini','PizzaHot'], detailedPoints: [{ day: 1, activity: 'Esterna', value: 2 }], eliminato: false},
